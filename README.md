...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-btm3jo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-btm3jo.containers.anotherwebservice.com/
...
```
git clone git@github.com:mikmc25/container-btm3jo.git
cd container-btm3jo
```
...
```
docker attach container-btm3jo
```
